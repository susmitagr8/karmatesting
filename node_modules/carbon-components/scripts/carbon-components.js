...
var Card = function (_mixin) {
  ...
  function Card(element, options) {
    ...
    var _this = possibleConstructorReturn(this, (Card.__proto__ || Object.getPrototypeOf(Card)).call(this, element, options));
  ...
  createClass(Card, [{
    ...
    value: function _cardKeyPress(event) {
      ...
      if (direction && card && card === document.activeElement) {
        var cards = [].concat(toConsumableArray(this.element.querySelectorAll(this.options.selectorCard)));
...
var DetailPageHeader = function (_mixin) {
  inherits(DetailPageHeader, _mixin);
  ...
  function DetailPageHeader(element, options) {
    classCallCheck(this, DetailPageHeader);

    var _this = possibleConstructorReturn(this, (DetailPageHeader.__proto__ || Object.getPrototypeOf(DetailPageHeader)).call(this, element, options));

    _this.previousScrollY = 0;
    // Debounce scroll event calls to handleScroll (default: 50)
    var debouncedScroll = lodash_debounce(_this._handleScroll.bind(_this), 25);
...
function svgToggleClass$1(svg, name, forceAdd) {
...
var InteriorLeftNav = function (_mixin) {
  inherits(InteriorLeftNav, _mixin);
  ...
  function InteriorLeftNav(element, options) {
    classCallCheck(this, InteriorLeftNav);

    var _this = possibleConstructorReturn(this, (InteriorLeftNav.__proto__ || Object.getPrototypeOf(InteriorLeftNav)).call(this, element, options));
  ...
  createClass(InteriorLeftNav, [{
    key: 'addActiveListItem',
    value: function addActiveListItem(item) {
      var _this2 = this;

      [].concat(toConsumableArray(this.element.querySelectorAll(this.options.selectorLeftNavListItem))).forEach(function (currentItem) {
        if (!(item === currentItem)) {
    ...
    value: function handleNestedListClick(listItem, evt) {
      ...
      var allNestedItems = [].concat(toConsumableArray(this.element.querySelectorAll(this.options.selectorLeftNavListItemHasChildren)));
      var isOpen = listItem.classList.contains(this.options.classExpandedLeftNavListItem);
      var list = listItem.querySelector(this.options.selectorLeftNavNestedList);
      var listItems = [].concat(toConsumableArray(list.querySelectorAll(this.options.selectorLeftNavNestedListItem)));

      if (!this.keepOpen) {
        allNestedItems.forEach(function (currentItem) {
          if (currentItem !== listItem) {
            svgToggleClass$1(currentItem, _this3.options.classExpandedLeftNavListItem, false);
          }
        });
      }

      if (!('InteriorLeftNavItemLink' in evt.target.dataset)) {
        svgToggleClass$1(listItem, this.options.classExpandedLeftNavListItem, !isOpen);
      }
...
var Search = function (_mixin) {
  ...
  function Search(element, options) {
    ...
    if (closeIcon) {
      _this.manage(on(closeIcon, 'click', function () {
        svgToggleClass$1(closeIcon, _this.options.classClearHidden, true);
        input.value = '';
        input.focus();
      }));
    }
  ...
  createClass(Search, [{
    ...
    value: function showClear(value, icon) {
      svgToggleClass$1(icon, this.options.classClearHidden, value.length === 0);
    }
...
var components = Object.freeze({
	...
	LeftNav: LeftNav,
	InteriorLeftNav: InteriorLeftNav,
